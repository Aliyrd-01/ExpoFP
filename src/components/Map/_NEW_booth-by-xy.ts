...
//@injectable
export default class BoothByXy {
    /**
     *
     */
    constructor(store: RootStore) {
        const boothStore = store.boothStore;
        ...
        this.getBoothIdFromClientXy = getLastBoothsFromClientXy; //(x, y, drawer) => getLastBoothsFromClientXy(x, y, drawer);
    }

    readonly getBoothIdFromClientXy: (x: number, y: number, drawer: Drawer) => Booth;

    // getBoothIdFromClientXy(x: number, y: number, drawer: Drawer): Booth {
