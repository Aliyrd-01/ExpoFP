...
import { BoothImage } from "../../../../utils/logosFromBooths";
...
export default async function configBg(
    ...
    return configImg(context, layerID, fpImages.concat(logos.map((i) => i.image)), painterOrderPriority + 6, false);
}
